# Melissa - ZIP*Data II Downloader
...
```
$ git clone https://github.com/MelissaData/ZIPDataII-Downloader
$ cd ZIPDataII-Downloader
```
...
You will need to set your license before running the `ZIPDataII_Downloader.ps1`. 
...
You will need to set your license before running the `ZIPDataII_Downloader.sh`. 
